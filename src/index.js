import './styles.css';
import {
  Project, Task, projects, loadProjectsIfExists, createTask,
} from './task';
import {
  loadAddTaskForm, loadAllTasklists, openTaskForm, closeTaskForm, loadTodayTasks, loadWeekTasks, loadImportantTasks,
} from './task-dom';
import {
  selectActiveSidebarButton, selectActiveProjectButton, loadProjectsToSidebar, updateAllCounters, reloadSelectedSidebarPage,
} from './sidebar';
